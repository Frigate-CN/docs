export const sidebar = [
  {
    ...
    items: [
      ...
      {
        text: '<i class="fa-solid fa-list-check"></i>安装规划',
        link: "frigate/planning_setup",
      },
      {
        text: '<i class="fa-solid fa-download"></i>安装',
        link: "/frigate/installation",
      },
      {
        text: '<i class="fa-solid fa-circle-up"></i>更新',
      ...
      {
        text: '<i class="fa-solid fa-timeline"></i>视频处理管线',
        link: "/frigate/video_pipeline",
      },
      {
        text: '<i class="fa-solid fa-file-lines"></i>术语表',
        link: "/frigate/glossary",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            text: '<i class="fa-solid fa-person"></i>物体/目标检测器',
            link: "/configuration/object_detectors",
          },
          {
            text: '<i class="fa-solid fa-volume-high"></i>音频检测器',
            link: "/configuration/audio_detectors",
          },
        ],
      },
      {
        ...
        items: [
          {
            text: '<i class="fa-solid fa-magnifying-glass-arrow-right"></i>语义搜索',
          ...
          {
            text: '<i class="fa-solid fa-car-side"></i>车牌识别',
            link: "/configuration/license_plate_recognition",
          },
          {
            text: '<i class="fa-solid fa-dove"></i>鸟类分类',
          ...
          {
            text: '<i class="fa-solid fa-comment"></i>生成式 AI',
            items: [
              {
                text: "配置生成式 AI",
      ...
      },
      {
        ...
        items: [
          {
            text: '<i class="far fa-camera"></i>摄像头',
            link: "/configuration/cameras",
          },
          {
            text: '<i class="fa-solid fa-check"></i>核查（原事件）',
            link: "/configuration/review",
          },
          {
            text: '<i class="fa-solid fa-compact-disc"></i>录制',
            link: "/configuration/record",
          },
          {
            text: '<i class="fa-solid fa-file-image"></i>快照',
            link: "/configuration/snapshots",
          },
          {
            text: '<i class="fa-solid fa-person-walking"></i>画面变动检测',
            link: "/configuration/motion_detection",
          },
          {
            text: '<i class="fa-solid fa-crow"></i>鸟瞰图',
            link: "/configuration/birdseye",
          },
          {
            text: '<i class="fa-solid fa-circle-play"></i>实时监控',
            link: "/configuration/live",
          },
          {
            text: '<i class="fa-regular fa-file-video"></i>转流传输',
            link: "/configuration/restream",
          },
          {
            text: '<i class="fa-solid fa-users-viewfinder"></i>自动追踪',
            link: "/configuration/autotracking",
          },
          {
            text: '<i class="fa-solid fa-circle-info"></i>特定摄像头',
            link: "/configuration/camera_specific",
          },
        ],
      },
      {
        ...
        items: [
          {
            text: '<i class="fa-solid fa-filter"></i>物体/目标过滤器',
            link: "/configuration/object_filters",
          },
          {
            text: '<i class="fa-solid fa-crop"></i>遮罩',
            link: "/configuration/masks",
          },
          {
            text: '<i class="fa-solid fa-crop-simple"></i>区域',
          ...
          {
            text: '<i class="fa-solid fa-wheelchair"></i>静止物体/目标',
            link: "/configuration/stationary_objects",
          },
        ],
      },
      {
        ...
        items: [
          {
            text: '<i class="fa-solid fa-video"></i>视频硬件加速',
            link: "/configuration/hardware_acceleration_video",
          },
          {
            text: '<i class="fa-solid fa-microchip"></i>增强硬件加速',
            link: "/configuration/hardware_acceleration_enrichments",
          },
        ],
      },
      {
