...
const teekConfig = defineTeekConfig({
  ...
  footerInfo: {
    ...
    bottomMessage: [
      `CDN 加速及安全防护由 <a href="https://edgeone.ai/zh?from=github" class="eo-logo"></a> 提供`,
    ],
    icpRecord: {
...
export default defineConfig(({ mode }) => {
  ...
  const isNoIndex = env?.VITE_SEO_NOINDEX === "true";
  return {
    transformPageData(pageData) {
      const canonicalUrl =
        `https://docs.frigate-cn.video/${pageData.relativePath}`
          .replace(/index\.md$/, "")
          .replace(/\.md$/, "")
          .replace(/\.html$/, "");
    ...
    head: [
      ...
      [
        "meta",
        { name: "baidu-site-verification", content: "codeva-GVV3NnQtwh" },
      ],
      [
        "meta",
        {
          name: "keywords",
          content:
            "Frigate,Frigate NVR,Frigate 中文文档,Frigate 中文,Frigate 中文社区,Frigate 中文网,Frigate 中文教程,Frigate 教程,Frigate 入门,Frigate 使用,Frigate 配置,Frigate 安装,Frigate Docker,Frigate Home Assistant,Frigate HA,Frigate AI 视频监控,NVR 视频监控,网络视频监控,视频监控系统",
        },
      ],
      [
        "meta",
      ...
      [
        ...
        {
          property: "og:image",
          content: "https://docs.frigate-cn.video/img/logo.svg",
        },
      ],
      [
        "link",
