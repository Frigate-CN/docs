...
This is the chinese documentation for the [Frigate](https://github.com/blakeblackshear/frigate/) project, built with VitePress.
...
- [CNB Issues](https://github.com/frigate-cn/docs/issues)
- [QQ Group](https://qm.qq.com/q/ul8QcaHWMM)