...
<i><img src="/assets/nvidia.png" class="logo-icon-16"></i> **NVIDIA**
...
<DetailsCollapse title="YOLOv9 配置">
...
<DetailsCollapse title="配置YOLO模型">
...
<DetailsCollapse title="配置 SSD 模型">
...
<DetailsCollapse title="MobileNet v2 配置">
...
<DetailsCollapse title="YOLO-NAS 配置">
...
#### YOLO(v3,v4,v7,v9)模型 {#yolo-v3-v4-v7-v9}
...
YOLO 检测器设计用于支持 YOLOv3、YOLOv4、YOLOv7 和 YOLOv9 模型，但也**有可能**支持其他 YOLO 模型架构。

注意，由于开源协议问题，**可能不支持** Ultralytics YOLO 模型。

:::

<DetailsCollapse title="YOLOv 配置">
...
<DetailsCollapse title="RF-DETR 配置">
...
<DetailsCollapse title="YOLO-NAS 模型配置">
...
<DetailsCollapse title="YOLOv 模型配置">
...
<DetailsCollapse title="YOLOx 模型配置">
...
<DetailsCollapse title="RF-DETR 模型配置">
...
### 下载 YOLO-NAS 模型 {#downloading-yolo-nas-model}
