...
### 限定警报和检测在特定区内 {#restricting-alerts-and-detections-to-specific-zones}
...
### 限定快照到特定区 {#restricting-snapshots-to-specific-zones}
...
### 限定区内的目标类型 {#restricting-zones-to-specific-objects}
...
#### 最佳实践与注意事项 {#best-practices-and-caveats}
