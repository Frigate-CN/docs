...
可以在全局配置中设置生成式 AI 服务提供商，能够让需要使用大模型的功能（例如[核查总结](genai_review.md)和[目标描述](genai_objects.md)）调用。目前有 3 种原生提供商可与 Frigate 集成。支持 OpenAI 标准 API 的其他服务提供商也可使用；请参阅下面的 OpenAI 部分。
