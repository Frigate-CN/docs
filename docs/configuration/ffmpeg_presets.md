...
### 硬件加速预设（hwaccel-args） {#hwaccel-presets}
...
### 输入参数预设（input_args） {#input-args-presets}
...
### 输出参数预设（output_args） {#output-args-presets}

输出参数预设可优化录制文件的生成逻辑，确保录制内容的一致性。

| 预设方案                         | 用途说明                     | 其他说明                                                                                                                                                     |
| -------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| preset-record-generic            | 无音频录制                   | 如果你的摄像头没有音频功能，或者你不想录制音频，请选择此选项                                                                                                 |
