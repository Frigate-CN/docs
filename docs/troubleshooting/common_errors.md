...
### Connection refused / No route to host / 401 Unauthorized / 404 Not Found
...
### Non-monotonic DTS / non monotonically increasing dts to muxer / Queue input is backward in time
...
### RTP: PT=xx: bad cseq (packet loss / reordering)
...
### error while decoding MB / non-existing PPS referenced (corrupt frames)
...
### Could not find codec parameters for stream ... unspecified size
...
### Failed to sync surface / Failed to download frame: -5 / Error while filtering
...
### No decoder surfaces left / Can't allocate a surface
...
### ONNX Runtime InvalidProtobuf / failed to load model
...
### CUDA failure 999 / CUDA failure 901
...
### Unable to start Frigate in safe mode / Starting Frigate in safe mode
...
### 502 Bad Gateway / connection refused to 127.0.0.1:5001
