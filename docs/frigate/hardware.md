...
Apple Silicon 无法在容器内运行，因此使用 ZMQ 代理与运行在主机上的 [Apple Silicon Frigate 检测器](https://github.com/frigate-nvr/apple-silicon-detector) 进行通信。在同一设备上运行时延迟极低。
